use utf8;
package FinSchema::Result::Dvigar;
...
=head1 TABLE: C<dvigar>

=cut

__PACKAGE__->table("dvigar");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:EaBRLQinYTE6Wkt3VXrCJw
