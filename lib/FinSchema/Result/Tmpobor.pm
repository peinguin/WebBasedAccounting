use utf8;
package FinSchema::Result::Tmpobor;
...
=head1 TABLE: C<tmpobor>

=cut

__PACKAGE__->table("tmpobor");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:KpqJQNjGMpn/VxMTJNUw4A
