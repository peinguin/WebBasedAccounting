use utf8;
package FinSchema::Result::Tmprozrah;
...
=head1 TABLE: C<tmprozrah>

=cut

__PACKAGE__->table("tmprozrah");
...
# DO NOT MODIFY THIS OR ANYTHING ABOVE! md5sum:JzHEAjT0uYm4OzygR6UNiw
